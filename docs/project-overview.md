...
```
churn_prediction         <- Root directory. Both monorepo and polyrepo are supported.
│
├── churn_prediction       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
