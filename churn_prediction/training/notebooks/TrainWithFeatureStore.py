...
# It is configured and can be executed as a training-job.tf job defined under ``churn_prediction/terraform``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-churn_prediction-experiment",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev-churn_prediction-model", label="Model Name"
)
