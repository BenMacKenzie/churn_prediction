...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``churn_prediction/terraform``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in churn_prediction/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in churn_prediction/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-churn_prediction-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-churn_prediction-model", "Model Name")
