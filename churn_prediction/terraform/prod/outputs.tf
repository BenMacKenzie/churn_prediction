...
output "churn_prediction_batch_inference_job_id" {
...
output "churn_prediction_experiment_id" {
  value = databricks_mlflow_experiment.experiment.id
}

output "churn_prediction_experiment_name" {
...
output "churn_prediction_model_name" {
...
output "churn_prediction_training_job_id" {
