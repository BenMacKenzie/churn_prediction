...
* Configure a Databricks CLI profile for your staging workspace by running
  ``databricks configure --token --profile "churn_prediction-staging" --host https://adb-984752964297111.11.azuredatabricks.net``, 
...
* Configure a Databricks CLI for your prod workspace by running ``databricks configure --token --profile "churn_prediction-prod" --host https://adb-984752964297111.11.azuredatabricks.net``
