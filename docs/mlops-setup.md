...
[ML Config](../churn_prediction/terraform/README.md) guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore .mlops-setup-scripts churn_prediction/terraform/README.md
...
We recommend including all files outside of `churn_prediction/terraform` in this PR:
...
Follow the instructions in [churn_prediction/terraform/README.md](../churn_prediction/terraform/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../churn_prediction/terraform/README.md) to propose, test, and deploy
