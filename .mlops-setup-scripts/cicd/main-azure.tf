resource "databricks_group" "mlops-service-principal-group-staging" {
  display_name = "churn_prediction-service-principals"
...
module "azure_create_sp" {
  ...
  service_principal_name       = "churn_prediction-cicd"
  project_directory_path       = "/churn_prediction"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "churn_prediction-service-principals"
}
